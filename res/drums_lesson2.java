...
public class drums_lesson2 extends AppCompatActivity implements View.OnClickListener {
    Button btn_Next;
    ImageButton btn_AB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drums_lesson2);
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            case R.id.btn_Next:
                ...
                App.instance().storeValueInt("DrumsL2",2);
                break;
        }
