...
public class drums_lesson6 extends AppCompatActivity implements View.OnClickListener {
    Button btn_Next;
    ImageButton btn_AB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drums_lesson6);
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            case R.id.btn_Next:
                ...
                App.instance().storeValueInt("DrumsL6",3);
                break;
        }
