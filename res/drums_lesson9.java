...
public class drums_lesson9 extends AppCompatActivity implements View.OnClickListener {
    Button btn_Next;
    ImageButton btn_AB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drums_lesson9);
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            case R.id.btn_Next:
                ...
                App.instance().storeValueInt("DrumsL9",3);
                break;
        }
