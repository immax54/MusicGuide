...
public class sin_lesson1 extends AppCompatActivity implements View.OnClickListener {
    Button btn_Next;
    ImageButton btn_AB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sin_lesson1);
    ...
    public void onClick(View v)
    {
        switch (v.getId()) {
            case R.id.btn_Next:
                ...
                App.instance().storeValueInt("SinL1",3);
                break;
        }
